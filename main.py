...
Premium quality lithophane lamp creator with advanced image processing and 3D mesh generation.

This modular version provides:
- Intelligent image processing with face detection
- Premium 3D cylinder generation
...
try:
    ...
    from src.core.settings import PremiumSettings, ConfigManager
    from src.gui.main_window import PremiumLampGeneratorApp
...
def load_application_settings(config_dir: Optional[Path] = None) -> PremiumSettings:
    """
...
def create_application() -> QApplication:
    ...
    app.setApplicationName("Premium Lithophane Lamp Generator")
    app.setApplicationDisplayName("מחולל מנורות ליטופן פרימיום")
...
def main() -> int:
    ...
    try:
        ...
        logger = logging.getLogger(__name__)
        logger.info("=== Premium Lithophane Lamp Generator Starting ===")
        ...
        try:
            main_window = PremiumLampGeneratorApp(settings)
