...
class SuccessDialog(QDialog):
    ...
    def create_header(self, parent_layout):
        ...
        # Subtitle
        self.subtitle_label = QLabel("Your Premium Lithophane Lamp is Ready!")
    ...
    def create_technical_quality_section(self, parent_layout):
        ...
        section = self.create_info_section(
            "Technical Quality",
            [
                f"Resolution: {self.statistics.get('resolution_mm', 0):.2f}mm (Premium Quality)",
