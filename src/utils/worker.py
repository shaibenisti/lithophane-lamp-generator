...
from ..processing.cylinder_builder import PremiumCylinderBuilder, CylinderBuildError
...
class LithophaneLampWorker(QThread):
    ...
    def __init__(self, image_path: str, output_path: str, 
                 settings: Optional[PremiumSettings] = None):
        """
        ...
        Args:
            ...
            settings: Premium settings (uses defaults if None)
        """
        super().__init__()
        
        self.image_path = image_path
        self.output_path = output_path
        self.settings = settings or PremiumSettings()
        ...
        self.cylinder_builder: Optional[PremiumCylinderBuilder] = None
    ...
    def run(self) -> None:
        ...
        try:
            ...
            self.progress_updated.emit(20, "Processing image for premium quality...")
            ...
            self.progress_updated.emit(40, "Building 3D cylinder with premium quality...")
    ...
    def _initialize_processors(self) -> None:
        ...
        try:
            ...
            self.cylinder_builder = PremiumCylinderBuilder(self.settings)
    ...
    def _format_success_message(self, stats: Dict[str, Any]) -> str:
        ...
        """
        message = f"""*** Premium Lithophane Lamp Completed Successfully! ***
...
TECHNICAL QUALITY:
* Resolution: {stats['resolution_mm']:.2f}mm (premium quality)
